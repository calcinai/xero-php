...
class Payment extends RemoteObject {
    ...
    /**
     * Exchange rate when payment is received. Only used for non base currency invoices and credit notes e.g. 
     * 0.7500 
     *
