...
class Model implements ParsedObjectInterface
{
    ...
    /**
     * The parent model of the object.
     * This is if it's defined as a secondary model on a doc page
     *
     ...
     * If it's a sub-model, needs to be in the NS of its parent.
     *
     * @return string
     */
    ...
    /**
     * Get the referenced classes in the object.
     * This is for the "use"s of type-hinted objects
     *
     * @return array
     */
    ...
    /**
     * Bit of a messy way to add properties at a position.
     * Just so it doesn't muck about the generated property order.
    ...
    /**
     * Set accepted methods for API call.
     * Only going to be set on models that can be referenced directly
     *
     * @param mixed $methods
     */
    ...
    /**
     * @see https://api.xero.com/api.xro/2.0/Contacts
     */
    ...
    public function printPropertyTable()
    {
        ...
        //Cannot echo the data types here.
        //They are lazily calculated after all the models are aware of each other.
